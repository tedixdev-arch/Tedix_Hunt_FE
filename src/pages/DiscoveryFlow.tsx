  ...
  return (
    <DiscoveryShell step={1}>
      <section className="flex flex-1 flex-col justify-center py-10">
        ...
        <h1 className="mt-4 text-5xl font-black leading-[0.95] tracking-[-0.045em]">Can your team bring it back?</h1>
        ...
        <Link className="mt-8 flex min-h-16 items-center justify-center rounded-xl bg-emerald-400 px-6 font-black text-slate-950" to="/discover/mini-hunt">
          Start the mini-hunt
        </Link>
  ...
  return (
    <DiscoveryShell step={3}>
      <section className="flex flex-1 flex-col justify-center py-9 text-center">
        ...
        <h1 className="mt-3 text-4xl font-black tracking-tight">You completed the mini-hunt!</h1>
        ...
        <div className="mt-7 rounded-2xl border border-white/10 bg-white/[0.05] p-5 text-left">
          ...
          <div className="mt-5 flex items-center gap-4"><div className="grid h-14 w-14 place-items-center rounded-xl bg-emerald-300 text-2xl">⚡</div><div><p className="font-black">Signal Restorer</p><p className="mt-1 text-sm text-slate-400">Sample achievement · Mini-hunt</p></div></div>
        </div>
        ...
        <Link className="mt-7 flex min-h-16 items-center justify-center rounded-xl bg-emerald-400 px-6 font-black text-slate-950" to="/join">Explore a full hunt</Link>
